-- --------------------------------------------------------------------------------
--  Program Name:   create_inventory_db.sql
...
, last_update_date)
VALUES
('ITEM','LAPTOP','Laptop', 1, UTC_DATE(), 1, UTC_DATE());
...
, last_update_date)
VALUES
('ITEM','DESKTOP','Desktop', 1, UTC_DATE(), 1, UTC_DATE());
...
, last_update_date)
VALUES
('ITEM','SERVER','Server', 1, UTC_DATE(), 1, UTC_DATE());
...
, last_update_date)
VALUES
('ITEM','PHONE','phone', 1, UTC_DATE(), 1, UTC_DATE());
...
, last_update_date)
VALUES
('ITEM','TABLET','Tablet', 1, UTC_DATE(), 1, UTC_DATE());
